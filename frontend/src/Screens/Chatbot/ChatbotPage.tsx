...
const handleKeyEvent = (e:React.KeyboardEvent<HTMLInputElement>)=>{
    ...
    return (
        <main className='w-full flex flex-col bg-base-100 text-base-content ' data-theme={theme ? "light" : 'dark'}>
            <section className='flex fixed top-0 z-3   w-full justify-between px-8 py-4 items-center border-b-1 border-gray-400 bg-base-100 '>
                <section className=''>
            ...
            <section className='flex md:pt-15 h-screen'>
                <section className='w-1/4 p-4 border-r-1 border-gray-400 shadow-md  sticky top-14  h-[calc(100%-0rem)]  hidden md:block  '>
                ...
                <div className='w-full flex flex-col relative '>
                    <div className='bg-base-100 w-full h-21 hidden md:flex gap-3  items-center sticky top-0 px-4 border-b-1 border-gray-400  '>
                    ...
                    <div className={`absolute bottom-0 px-3 md:px-10 w-full items-center flex ${theme ? 'bg-blue-100' : "bg-base-100"} `}>
